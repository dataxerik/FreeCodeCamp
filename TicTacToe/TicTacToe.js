...
const UIManager = {
  ...
  onGameOver: winner => {
      winner = winner == 'first player' ? "playerOne" : "playerTwo";
      console.log(this);
...
const Manager = {
  ...
  updateBoard: function(boxIdNumber) {
    ...
    if (this.gameManager.checkIfGameOver()) {
      this.UIManager.displayResultScreen(currentPlayerName);
      this.resetBoard();
    } else {
...
$(document).ready(function() {
  UIManager.onGameOver('first player');
  Manager.onLoad();
